...
final class Admin_Page extends Menu_Page {
	...
	public function enqueue( Page $page ): void {
		...
		// Point WordPress at the plugin's `languages/` directory so the PHP
		// translation files generated by `composer i18n:makephp` reach the
		// Elm bundle. The text domain matches the one declared in the plugin
		// header and used by `Load_Text_Domain`; the path is the same
		// directory `i18n:makephp` writes into.
		wp_set_script_translations(
			self::ASSET_HANDLE,
			Plugin_Config::TEXT_DOMAIN,
